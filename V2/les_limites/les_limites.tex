...
\definition{}{
    ...
    $(P)$: \frquote{$\forall\varepsilon\in\R^+_*, \exists N\in\N, \forall n\in\N, n\geq N : l-\varepsilon<u_n<l+\varepsilon$}\\
    On dit que la suite $u$ converge vers $l$ et on note : $\lim{n\to+\infty}u_n=l$
}

\theoreme{}{
    Soient $u$ et $v$ deux suites. Soient $l$ et $l'$ deux réels.\\
    Si $\lim{n\to+\infty}u_n=l$ et $\lim{n\to+\infty}v_n=l'$ et $l<l'$ alors $\exists N\in\N, \forall n\in\N, n\geq N : u_n < v_n$
}
...
\theoreme{de comparaison des limites}{
    Soient $u$ et $v$ deux suites. Soient $l$ et $l'$ deux réels.\\
    Si $\exists N\in\N, \forall n\in\N, n\geq N : u_n\leq v_n$ et $\lim{n\to+\infty}u_n=l$ et $\lim{n\to+\infty}v_n=l'$ alors $l\leq l'$.
}

\theoreme{des gendarmes}{
    Soient $u$, $v$ et $w$ trois suites. Soient $l$ un réel.\\
    Si $\exists N\in\N, \forall n\in\N, n \geq N : u_n\leq v_n \leq w_n$ et $\lim{n\to+\infty}u_n=l$ et $\lim{n\to+\infty}w_n=l$
...
\definition{}{
    ...
    $(P)$ : \frquote{$\forall A\in\R, \exists N\in\N,\forall n\in\N, n\geq N : u_n>A$}.\\
...
\theoreme{de comparaison}{
    ...
    Si $\exists N\in\N, \forall n\in\N, n\geq N : u_n\geq v_n$ et $\lim{n\to+\infty}v_n=+\infty$ alors $\lim{n\to+\infty}u_n=+\infty$.
}
...
\theoreme{de comparaison}{
    Soient $u$ et $v$ deux suites.\\
    Si $\exists N\in\N, \forall n\in\N, n\geq N : u_n\leq v_n$ et $\lim{n\to+\infty}v_n=-\infty$ alors $\lim{n\to+\infty}u_n=-\infty$.
